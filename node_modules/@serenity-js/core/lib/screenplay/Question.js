...
class Question extends Describable_1.Describable {
    ...
    static createAdapter(statement) {
        ...
        if (typeof statement[node_util_1.default.inspect.custom] === 'function') {
            Object.defineProperty(
            // statement must be a function because Proxy apply trap works only with functions
            getStatement, node_util_1.default.inspect.custom, {
                value: statement[node_util_1.default.inspect.custom].bind(statement),
                writable: false,
            });
        }
        return new Proxy(getStatement, {
            get(currentStatement, key, receiver) {
                ...
                if (key === node_util_1.default.inspect.custom) {
                    return target[node_util_1.default.inspect.custom].bind(target);
                }
...
class QuestionStatement extends Interaction_1.Interaction {
    ...
    [node_util_1.default.inspect.custom](depth, options, inspect) {
