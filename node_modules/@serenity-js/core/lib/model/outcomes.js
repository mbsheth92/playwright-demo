...
class ExecutionSkipped extends Outcome {
    error;
    static Code = 1 << 5;
    static fromJSON = (o) => new ExecutionSkipped(o.error && errors_1.ErrorSerialiser.deserialise(o.error));
    constructor(error) {
    ...
    toJSON() {
        return {
            code: this.code,
            error: this.error && errors_1.ErrorSerialiser.serialise(this.error),
        };
    }
}
